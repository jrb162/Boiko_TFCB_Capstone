...
In working with the data, I made the assumption that it had been tabulated error-free (aside from the above missing data) and that it was also a complete data set reflective of the data analyzed in the published paper. 
...
data_renamed4 <- read.csv(
  file = "~/Boiko_TFCB_Capstone/data_renamed.csv",
  header = TRUE,
  sep = ",",
  dec = "."
)
